...
define view entity Z054906_TravelWithCustomer
  as select from Z054906_Travel     as Travel

    inner join   Z054906_Customer   as Customer   on Customer.CustomerId = Travel.CustomerId
    inner join   Z054906_StatusText as StatusText on Travel.Status = StatusText.value_low
